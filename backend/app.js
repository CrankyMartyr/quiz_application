...
app.use("/api", authRoutes); // For login functionality
app.use("/api", quizRoutes); // For quiz creation, editing, and viewing
app.use("/api", attemptRoutes); // For storing and viewing quiz attempts
